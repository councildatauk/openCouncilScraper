...
$monster[314][2] = '//h3[contains(text(),"Ward")]';
...
echo $wTmp."---";
 ...
 $monster[303][0] = '//h3[text()="'.$wTmp.'"]/following-sibling::div[position()<4]/span/span/a';
 $monster[303][1] = '//h3[text()="'.$wTmp.'"]/following-sibling::div[position()<4]/span/span/text()';
 $monster[305][0] = '//h3[text()="'.$wTmp.'"]/following-sibling::ul[1]/li/a[contains(@href,"councillor-")]';
 $monster[305][1] = '//h3[text()="'.$wTmp.'"]/following-sibling::ul[1]/li/a[contains(@href,"councillor-")]';
 ...
 $monster[314][0] = '//h3[text()="'.$wTmp.'"]/following-sibling::div/div/div/strong';
 $monster[314][1] = '//h3[text()="'.$wTmp.'"]/following-sibling::div/div/div/text()[1][normalize-space(.)]';
